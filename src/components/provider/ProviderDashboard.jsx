    ...
    if (mode === 'existing') {
      ...
      fetch(`${API_URL}/api/patients`)
        ...
        .catch(() => {
          ...
          setPatients([
            { id: 1, name: 'Sarah Johnson', dob: '1990-03-12', phone: '2145550101', reason: 'Follow-up', history: [
              { date: '2025-11-10', reason: 'Chest pain', diagnosis: 'Stable angina', medication: 'Aspirin 81mg' },
            ]},
            { id: 2, name: 'Marcus Lee', dob: '1972-07-25', phone: '2145550182', reason: 'Chest pain', history: [] },
            { id: 3, name: 'Priya Patel', dob: '1996-11-04', phone: '2145550143', reason: 'Annual checkup', history: [] },
            { id: 4, name: 'David Kim', dob: '1963-01-18', phone: '2145550167', reason: 'Diabetes review', history: [] },
            { id: 5, name: 'Linda Torres', dob: '1979-06-30', phone: '2145550199', reason: 'Back pain', history: [] },
          ]);
          setLoadingPatients(false);
        });
    }
        ...
        <div className="pdash__section">
          ...
          <div className="pdash__form">
            ...
            <button
              ...
              onClick={() => navigate('/provider/record', { state: { isExisting: false, patient: newPatient } })}
            >
              Start Recording
            </button>
          </div>
      ...
      {mode === 'existing' && (
        <div className="pdash__section">
          ...
          <div className="pdash__form">
            ...
            <button className="pdash__btn" onClick={handleSearch}>
              {loadingPatients ? 'Loading...' : 'Look Up Patient'}
            </button>
          </div>
            ...
            <div className="pdash__result">
              <div className="pdash__patient">
                ...
                <div className="pdash__patient-actions">
                  ...
                  <button
                    className="pdash__action pdash__action--record"
                    onClick={() => navigate('/provider/record', { state: { isExisting: true, patient: result } })}
                  >
                    Record
                  </button>
                </div>
